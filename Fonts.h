...
MD_MAX72XX::fontType_t _stdProp[] PROGMEM = {
0,		// 0 - 'Empty Cell'
...
MD_MAX72XX::fontType_t _renoFont[] PROGMEM = {
0,		// 0 - 'Empty Cell'
5, 62, 91, 79, 91, 62,		// 1 - 'Sad Smiley'
5, 62, 107, 79, 107, 62,		// 2 - 'Happy Smiley'
5, 28, 62, 124, 62, 28,		// 3 - 'Heart'
...
2, 96, 96,		// 46 - '.'
5, 32, 16, 8, 4, 2,		// 47 - '/'
5, 127, 127, 65, 127, 127,		// 48 - '0'
3, 0, 127, 127,		// 49 - '1'
5, 123, 107, 107, 107, 111,		// 50 - '2'
5, 99, 99, 107, 107, 127,		// 51 - '3'
5, 31, 31, 16, 127, 127,		// 52 - '4'
5, 111, 107, 107, 107, 123,		// 53 - '5'
5, 127, 111, 108, 108, 124,		// 54 - '6'
5, 3, 3, 3, 127, 127,		// 55 - '7'
5, 127, 107, 107, 107, 127,		// 56 - '8'
5, 31, 27, 27, 123, 127,		// 57 - '9'
2, 54, 54,		// 58 - ':'
2, 128, 104,		// 59 - ';'
4, 8, 20, 34, 65,		// 60 - '<'
5, 20, 20, 20, 20, 20,		// 61 - '='
...
MD_MAX72XX::fontType_t _renoFont8px[] PROGMEM = {
	0,		// 0 - 'Empty Cell'
	6, 3, 3, 252, 252, 204, 204,		// 1 - 'Deg C'
5, 62, 107, 79, 107, 62,		// 2 - 'Happy Smiley'
5, 28, 62, 124, 62, 28,		// 3 - 'Heart'
5, 24, 60, 126, 60, 24,		// 4 - 'Diamond'
5, 28, 87, 125, 87, 28,		// 5 - 'Clubs'
...
5, 20, 127, 20, 127, 20,		// 35 - '#'
//5, 36, 42, 127, 42, 18,		// 36 - '$'
5, 3, 3, 252, 252, 204,		// 36 - 'Deg C' - key $"
5, 35, 19, 8, 100, 98,		// 37 - '%'
5, 54, 73, 86, 32, 80,		// 38 - '&'
3, 8, 7, 3,		// 39 - '''
3, 28, 34, 65,		// 40 - '('
...
5, 8, 8, 8, 8, 8,		// 45 - '-'
2, 96, 96,		// 46 - '.'
5, 192, 112, 60, 14, 3,		// 47 - '/'
5, 255, 255, 195, 255, 255,		// 48 - '0'
5, 0, 0,255, 255,0,		// 49 - '1'
5, 251, 251, 219, 223, 223,		// 50 - '2'
5, 195, 195, 219, 219, 255,		// 51 - '3'
5, 31, 31, 24, 255, 255,		// 52 - '4'
5, 223, 223, 219, 251, 251,		// 53 - '5'
5, 255, 255, 216, 248, 248,		// 54 - '6'
5, 3, 3, 3, 255, 255,		// 55 - '7'
5, 255, 255, 219, 255, 255,		// 56 - '8'
5, 31, 31, 27, 255, 255,		// 57 - '9'
2, 108, 108,		// 58 - ':'
2, 128, 104,		// 59 - ';'
4, 8, 20, 34, 65,		// 60 - '<'
5, 20, 20, 20, 20, 20,		// 61 - '='
